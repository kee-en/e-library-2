                    ...
                    <div class="nk-block-head nk-block-head-lg wide-md">
                        <div class="nk-block-head-content">
                            ...
                            <div class="nk-block-des">
                                <p class="lead">Got a question? Can't find the answer you're looking for? Don't worry, drop us a line on our <a href="<?=base_url('contact-us'); ?>">contact page</a>.</p>
                            </div>
                        </div>
                    </div>
                    <div class="nk-block">
                                    ...
                                    <div id="faqs" class="accordion">
                                        <div class="accordion-item">
                                            <a href="#" class="accordion-head" data-bs-toggle="collapse" data-bs-target="#faq-q1">
                                                <h6 class="title">Do I need special software or hardware to read e-books?</h6>
                                        ...
                                        <div class="accordion-item">
                                            <a href="#" class="accordion-head collapsed" data-bs-toggle="collapse" data-bs-target="#faq-q2">
                                                <h6 class="title">How do I get help if I have a problem?</h6>
                                                <span class="accordion-icon"></span>
                                            </a>
                                        ...
                                        <div class="accordion-item">
                                            <a href="#" class="accordion-head collapsed" data-bs-toggle="collapse" data-bs-target="#faq-q3">
                                                <h6 class="title">Can I download e-books on to my hand held device?</h6>
                                                <span class="accordion-icon"></span>
                                            </a>
                                    ...
                                    <div class="card-inner">
                                        <div class="align-center flex-wrap g-4 text-center">
                                            ...
                                            <div class="nk-block-content flex-shrink-0 mt-lg-4 mx-auto">
                                                <a href="<?=base_url('contact-us'); ?>" class="btn btn-lg btn-outline-primary">Get Support</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
