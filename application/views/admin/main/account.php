                                            ...
                                            <div class="nk-block-between">
                                                <div class="nk-block-head-content">
                                                    ...
                                                    <div class="nk-block-des">
                                                        <p>Basic info, like your name and address, that you use inside this platform.</p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="nk-data data-list">
                                                ...
                                                <div class="data-item" data-bs-toggle="modal" data-bs-target="#EditAccountModal">
                                                    <div class="data-col">
                                                        ...
                                                        <span class="data-value">March 4, 1989</span>
                                                    </div>
                                                    <div class="data-col data-col-end"><span class="data-more"><em class="icon ni ni-forward-ios"></em></span></div>
                                                </div>
                                            ...
                                            <div class="gy-3">
                                                <div class="g-item">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="latest-sale">Notify me by email about new upload e-books</label>
                                                    </div>
                                                </div>
                                                <div class="g-item">
                                                    <div class="custom-control custom-switch">
                                ...
                                <div class="card-inner-group" data-simplebar>
                                    ...
                                    <div class="card-inner p-0">
                                        <ul class="nav link-list-menu border border-light round m-0">
                                            <li>
                                                <a class="active" data-bs-toggle="tab" href="#profile_tab"><em class="icon ni ni-user-fill-c"></em><span>Personal Infomation</span></a>
                                            </li>
                                            <li>
                                                <a data-bs-toggle="tab" href="#notifications_tab"><em class="icon ni ni-bell-fill"></em><span>Notifications</span></a>
                                            </li>
                                            <li>
                                                <a data-bs-toggle="tab" href="#activity_tab"><em class="icon ni ni-activity-round-fill"></em><span>Account Activity</span></a>
                                            </li>
                                            <li>
                                                <a data-bs-toggle="tab" href="#security_tab"><em class="icon ni ni-lock-alt-fill"></em><span>Security Settings</span></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
